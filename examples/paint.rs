...
async fn main() -> io::Result<()> {
    ...
    loop {
                ...
                Event::Mouse(MouseEvent {
                    ...
                    MouseEventKind::Drag(_) => {
                        if is_drawing {
                            renderer
                                .canvas_mut()
                                .set_cell(column, row, '█', Some(active_color));
                        }
                    }
                    _ => {}
                },
        ...
        // --- OVERLAY: UI ---
        canvas.draw_gradient_text_z(
            2,
            1,
            "MACHTUI CANVAS PAINT",
            (255, 0, 255),
            (0, 255, 255),
            10,
        );
        canvas.draw_text_z(
            2,
            2,
            "Colors: 1:Red 2:Grn 3:Blu 4:Yel | C:Clear | Q:Quit",
            Some(Color::White),
            10,
        );
